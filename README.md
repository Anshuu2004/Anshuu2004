...
> **Open to Backend · Full-Stack · Cloud/DevOps · AI/ML opportunities**
> 📍 Bhopal, India — open to **Remote** &nbsp;·&nbsp; 💬 **abhishekcse2004@gmail.com**

I ship end-to-end: from backend and data to a deployed product — usually with AI in the loop, and always with the boring-but-critical parts done right (auth, fallbacks, tests).

---

## ⚡ Highlights

- 🤖 Built an **autonomous AI agent** that fixes bugs and **opens its own pull requests**, verified through a **6-model pipeline**
- 👁️ Shipped **real-time computer vision at 25–30 FPS on a plain CPU** — no GPU, model bundle **under 8 MB**
- 💸 Engineered **integer-exact money math** + **Postgres Row-Level Security** for a multi-currency expense splitter
- 📝 Generated **board-aligned exam papers in English & Hindi** with a 4-tier AI fallback
- 🚀 **3 projects running live in production** (links below)

---

## 🧑‍💻 About Me

I'm a CS engineer who likes taking an idea all the way to a deployed, working system. My work spans **autonomous AI agents, full-stack web apps, backend services, and on-device computer vision** — and I care about the details that make software hold up: deterministic logic, real authorization, fallbacks, and tests.
...
[![Skills](https://skillicons.dev/icons?i=python,ts,js,react,nextjs,tailwind,vite)](https://skillicons.dev)

**Backend & Data**

[![Skills](https://skillicons.dev/icons?i=nodejs,express,flask,postgres,mysql,sqlite,supabase)](https://skillicons.dev)
...
**Computer Vision · DevOps · Tools**

[![Skills](https://skillicons.dev/icons?i=opencv,docker,git,github,linux)](https://skillicons.dev)
...
<img height="165" src="https://github-readme-stats.vercel.app/api?username=Anshuu2004&show_icons=true&count_private=true&include_all_commits=true&theme=tokyonight&hide_border=true" />
